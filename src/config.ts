...
const DEFAULT_AVATAR_PATH = './assets/images/demo-avatar.png';
const DEFAULT_BANNER_PATH = './assets/images/demo-banner.png';
export const siteConfig: SiteConfig = {
  ...settings.site,
  banner: {
    ...settings.site.banner,
    src: settings.site.banner.src || DEFAULT_BANNER_PATH,
  },
};
export const profileConfig: ProfileConfig = {
  ...settings.profile,
  avatar: settings.profile.avatar || DEFAULT_AVATAR_PATH,
};
